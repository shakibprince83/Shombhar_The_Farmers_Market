...
<?php
						    ...
						    <tr>
						      ...
						      <td>&nbsp;$rs[status]</td>
						      <td>&nbsp;  <a href='seller.php?editid=$rs[seller_id]' class='btn btn-info'>Edit</a><br><a href='viewseller.php?deleteid=$rs[seller_id]' onclick='return delconfirm()' class='btn btn-danger'>Delete</a></td>
					        </tr>";
							  }
							  ?>
								</TBODY>
