...
// CSRF protection with random number
if($_SESSION['randnumber'] == $_POST['randnumber'])
{
    if(isset($_POST['submit']))
    {
        // Fetch the user by email
        $email = mysqli_real_escape_string($con, $_POST['emailid']); // Prevent SQL injection
        $sql = "SELECT * FROM customer WHERE email_id='$email' AND status='Active'";
...
// Generate new random number for CSRF protection
$randnumber = rand();
