...
if(isset($_POST['submit']))
{
	...
	{
		$sql ="UPDATE article SET `article_type`='$_POST[articletype]', `publish_date`='$_POST[publishdate]', `title`='$_POST[title]', `article_description`='$_POST[description]'";
		if($_FILES['img1']['name'] != "")
		{
...
if(isset($_GET['editid'])) {
?>
	<input type="hidden" name="article_id" id="article_id" value="<?php echo $_GET['editid']; ?>">
<?php
} else {
?>
...
<div class="form-row">
	...
	<div class="col-md-6 form-group">
		...
		if(isset($_GET['editid']))
		{
			if($rsedit['article_img1'] != "" && file_exists("imgarticle/$rsedit[article_img1]"))
			{
				echo "<img src='imgarticle/$rsedit[article_img1]' height='100' width='100'>";
			}
		}
		?>
	</div>	
	<div class="col-md-6 form-group">
		...
		if(isset($_GET['editid']))
		{
			if($rsedit['article_img2'] != "" && file_exists("imgarticle/$rsedit[article_img2]"))
			{
				echo "<img src='imgarticle/$rsedit[article_img2]' height='100' width='100'>";
			}
		}
		?>
	</div>	
	<div class="col-md-6 form-group">
		...
		if(isset($_GET['editid']))
		{
			if($rsedit['article_img3'] != "" && file_exists("imgarticle/$rsedit[article_img3]"))
			{
				echo "<img src='imgarticle/$rsedit[article_img3]' height='100' width='100'>";
			}
		}
		?>
	</div>	
	<div class="col-md-6 form-group">
		...
		if(isset($_GET['editid']))
		{
			if($rsedit['article_img4'] != "" && file_exists("imgarticle/$rsedit[article_img4]"))
			{
				echo "<img src='imgarticle/$rsedit[article_img4]' height='100' width='100'>";
			}
		}
		?>
	</div>	
	<div class="col-md-6 form-group">
		...
		if(isset($_GET['editid']))
		{
			if($rsedit['article_img5'] != "" && file_exists("imgarticle/$rsedit[article_img5]"))
			{
				echo "<img src='imgarticle/$rsedit[article_img5]' height='100' width='100'>";
			}
		}
		?>
	</div>	
...
?>
	...
	function validatearticle()
	{
				...
				else if(document.frmarticle.img1.value == "" && document.frmarticle.article_id.value == "")
				{
