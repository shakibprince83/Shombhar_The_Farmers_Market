...
<?php
							...
							<table ID="datatable" class="table table-striped table-bordered"  style="width:100%">
							  ...
							  <tr>
							    ...
							    <td>&nbsp;$rs[status]</td>
							    <td><a href='customerReg.php?editid=$rs[customer_id]' class='btn btn-info' style='width: 100%;' >Edit</a> <a href='viewcustomerReg.php?deleteid=$rs[customer_id]' onclick='return delconfirm()' class='btn btn-danger'  style='width: 100%;' >Delete</a></td>
						      </tr>";
							  }
							  ?>
								</TBODY>
