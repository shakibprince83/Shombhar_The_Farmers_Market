...
<div class="form-row">
	...
	<div class="col-md-6 form-group">
	Swift Code  <font color="#FF0000">*</font>
...
?>
      ...
      function validatesellreg()
	  {
		  ...
		  else if(!document.frmsellreg.sellername.value.match(alphaspaceExp))
		{
		  ...
		  else if(document.frmsellreg.contactnumber.value == "")
		  {
			...
			else if(document.frmsellreg.mbnumber.value.length != 11)
			{
	...
	else if(document.frmsellreg.cpassword.value == "")
	{
		    ...
		    else if(!document.frmsellreg.branch.value.match(alphaspaceExp))
		{
		  ...
		  {
			alert("Kindly enter a valid 8 Characters Swift Code...");
			document.frmsellreg.ifsccode.focus();
			return false;
		  }
		   else if(document.frmsellreg.ifsccode.value.length < 8)
		  {
			alert("Kindly enter a valid 11 Characters Swift Code...");
			document.frmsellreg.ifsccode.focus();
			return false;
		  }
