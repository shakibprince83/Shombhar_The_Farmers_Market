			...
			$rsproduct = mysqli_fetch_array($qsqlproduct);
			  ...
			  echo "
					...
					<td>&nbsp;<img src='imgproduct/$rsproduct[img_1]' width='25' height='25'></td>
					  ...
					  <td>&nbsp;" . $config['CURRENCY_SYMBOL'] . " $rspurchase_order[quantity]&nbsp;$rsproduct[quantity_type]</td>
					  <td>&nbsp;<span id='calccost$i'>" . $config['CURRENCY_SYMBOL']  . $rspurchase_order['purchase_amt'] ."</span></td>					  
					</tr>";
	  ?>
    <tr>
      ...
      <th>&nbsp; <?php echo $config['CURRENCY_SYMBOL']; ?> <?php echo $rspurchase_order['purchase_amt']; ?></th>
