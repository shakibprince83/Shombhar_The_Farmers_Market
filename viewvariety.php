...
<?php
						    ...
						    <tr>
						      ...
						      <td>&nbsp;$rs[status]</td>
							  <td><a href='variety.php?editid=$rs[variety_id]' CLASS='btn btn-info' style='width: 100%'>Edit</a> <a href='viewvariety.php?deleteid=$rs[variety_id]' onclick='return delconfirm()' CLASS='btn btn-danger' style='width: 100%'>Delete</a></td>
					        </tr>";
							  }
							  ?>
								</TBODY>
