...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 26, 2025 at 08:33 PM
...
(34, 'Blog', '2025-01-19', 'Smart Farming: How Technology Can Revolutionize Agriculture', 'Modern technology is reshaping agriculture, making it more efficient and sustainable. Learn how precision farming tools, IoT devices, and drones can optimize crop management, reduce wastage, and increase yields. Discover affordable ways to adopt these technologies, even on small-scale farms.', '2049773261download.jpg', '622152412download.jpg', '1641167528download.jpg', '988870408download.jpg', '1099372981download.jpg', 'Active'),
(35, 'Blog', '2025-01-21', 'Sustainable Farming Practices for Long-Term Benefits', 'Sustainability is key to preserving farmland for future generations. This article explores techniques like crop rotation, organic farming, and composting to improve soil health. It also highlights methods to reduce chemical inputs, conserve water, and promote biodiversity on farms.', '1961731688images.jpg', '184916911images.jpg', '885015855images.jpg', '852926287images.jpg', '1316976657images.jpg', 'Active');
...
CREATE TABLE `chat` (
  ...
  `sender_type` enum('customer','seller','worker') NOT NULL,
  `receiver_type` enum('customer','seller','worker') NOT NULL,
...
(1, 1, 1, 'Dhaka', 'District in Bangladesh', 'active'),
(2, 1, 1, 'Faridpur', 'District in Bangladesh', 'active'),
(3, 1, 1, 'Gazipur', 'District in Bangladesh', 'active'),
(4, 1, 1, 'Gopalganj', 'District in Bangladesh', 'active'),
(5, 1, 1, 'Jamalpur', 'District in Bangladesh', 'active'),
(6, 1, 1, 'Kishoreganj', 'District in Bangladesh', 'active'),
(7, 1, 1, 'Madaripur', 'District in Bangladesh', 'active'),
(8, 1, 1, 'Manikganj', 'District in Bangladesh', 'active'),
(9, 1, 1, 'Munshiganj', 'District in Bangladesh', 'active'),
(10, 1, 1, 'Mymensingh', 'District in Bangladesh', 'active'),
(11, 1, 1, 'Narayanganj', 'District in Bangladesh', 'active'),
(12, 1, 1, 'Narsingdi', 'District in Bangladesh', 'active'),
(13, 1, 1, 'Netrokona', 'District in Bangladesh', 'active'),
(14, 1, 1, 'Rajbari', 'District in Bangladesh', 'active'),
(15, 1, 1, 'Shariatpur', 'District in Bangladesh', 'active'),
(16, 1, 1, 'Sherpur', 'District in Bangladesh', 'active'),
(17, 1, 1, 'Tangail', 'District in Bangladesh', 'active'),
(18, 1, 4, 'Bogra', 'District in Bangladesh', 'active'),
(19, 1, 4, 'Joypurhat', 'District in Bangladesh', 'active'),
(20, 1, 4, 'Naogaon', 'District in Bangladesh', 'active'),
(21, 1, 4, 'Natore', 'District in Bangladesh', 'active'),
(22, 1, 4, 'Nawabganj', 'District in Bangladesh', 'active'),
(23, 1, 4, 'Pabna', 'District in Bangladesh', 'active'),
(24, 1, 4, 'Rajshahi', 'District in Bangladesh', 'active'),
(25, 1, 4, 'Sirajganj', 'District in Bangladesh', 'active'),
(26, 1, 7, 'Dinajpur', 'District in Bangladesh', 'active'),
(27, 1, 7, 'Gaibandha', 'District in Bangladesh', 'active'),
(28, 1, 7, 'Kurigram', 'District in Bangladesh', 'active'),
(29, 1, 7, 'Lalmonirhat', 'District in Bangladesh', 'active'),
(30, 1, 7, 'Nilphamari', 'District in Bangladesh', 'active'),
(31, 1, 7, 'Panchagarh', 'District in Bangladesh', 'active'),
(32, 1, 7, 'Rangpur', 'District in Bangladesh', 'active'),
(33, 1, 7, 'Thakurgaon', 'District in Bangladesh', 'active'),
(34, 1, 6, 'Barguna', 'District in Bangladesh', 'active'),
(35, 1, 6, 'Barisal', 'District in Bangladesh', 'active'),
(36, 1, 6, 'Bhola', 'District in Bangladesh', 'active'),
(37, 1, 6, 'Jhalokati', 'District in Bangladesh', 'active'),
(38, 1, 6, 'Patuakhali', 'District in Bangladesh', 'active'),
(39, 1, 6, 'Pirojpur', 'District in Bangladesh', 'active'),
(40, 1, 2, 'Bandarban', 'District in Bangladesh', 'active'),
(41, 1, 2, 'Brahmanbaria', 'District in Bangladesh', 'active'),
(42, 1, 2, 'Chandpur', 'District in Bangladesh', 'active'),
(43, 1, 2, 'Chattogram', 'District in Bangladesh', 'active'),
(44, 1, 2, 'Cumilla', 'District in Bangladesh', 'active'),
(45, 1, 2, 'Cox\'s Bazar', 'District in Bangladesh', 'active'),
(46, 1, 2, 'Feni', 'District in Bangladesh', 'active'),
(47, 1, 2, 'Khagrachari', 'District in Bangladesh', 'active'),
(48, 1, 2, 'Lakshmipur', 'District in Bangladesh', 'active'),
(49, 1, 2, 'Noakhali', 'District in Bangladesh', 'active'),
(50, 1, 2, 'Rangamati', 'District in Bangladesh', 'active'),
(51, 1, 5, 'Habiganj', 'District in Bangladesh', 'active'),
(52, 1, 5, 'Maulvibazar', 'District in Bangladesh', 'active'),
(53, 1, 5, 'Sunamganj', 'District in Bangladesh', 'active'),
(54, 1, 5, 'Sylhet', 'District in Bangladesh', 'active'),
(55, 1, 3, 'Bagerhat', 'District in Bangladesh', 'active'),
(56, 1, 3, 'Chuadanga', 'District in Bangladesh', 'active'),
(57, 1, 3, 'Jessore', 'District in Bangladesh', 'active'),
(58, 1, 3, 'Jhenaidah', 'District in Bangladesh', 'active'),
(59, 1, 3, 'Khulna', 'District in Bangladesh', 'active'),
(60, 1, 3, 'Kushtia', 'District in Bangladesh', 'active'),
(61, 1, 3, 'Magura', 'District in Bangladesh', 'active'),
(62, 1, 3, 'Meherpur', 'District in Bangladesh', 'active'),
(63, 1, 3, 'Narail', 'District in Bangladesh', 'active'),
(64, 1, 3, 'Satkhira', 'District in Bangladesh', 'active');
...
(1, 'Bangladesh', 'Bangladesh Country', 'Active');
...
INSERT INTO `customer` (`customer_id`, `customer_name`, `address`, `country_id`, `state_id`, `city_id`, `pincode`, `contact_no`, `mobile_no`, `email_id`, `password`, `customer_type`, `status`, `reset_token`, `reset_token_expiry`) VALUES
(9, 'Mahmud', 'Souza1Mahmud5', 1, 1, 1, '1230', '01798210032', '01798210032', 'Souza1Mahmud5@gm.com', 'Souza1Mahmud5', 'Consumer', 'Active', NULL, NULL),
(11, 'dfsfd', 'Nurul Ahad Masjid Road, Dewanbari, Dakshinkhan, Dhaka-1230', 1, 1, 11, '1212', '01533831269', '01798210399', 'Souza1Mahmud52@gm.com', 'Souza1Mahmud52', 'Consumer', 'Active', NULL, NULL),
(13, 'fsgsgs', 'fcbfdd', 1, 1, 10, '1230', '01798210399', '01798210399', 'Souza1Mahmud555@gm.com', '$2y$10$k0dG6W0YA6kpevN0Ka', 'Consumer', 'Active', NULL, NULL),
(14, 'fsgsgs', 'Souza1Mahmud5551', 1, 1, 15, '1230', '01798210399', '01798210399', 'Souza1Mahmud5551@gm.com', '$2y$10$Zr7gdBbvxhf95KhWEB', 'Consumer', 'Active', NULL, NULL),
(15, 'fsgsgs', 'Souza1Mahmud555155', 1, 1, 15, '1230', '01798210399', '01798210399', 'Souza1Mahmud555155@gm.com', '$2y$10$Y1F25TreY5i6Bb/ei0', 'Consumer', 'Active', NULL, NULL),
(16, 'fsgsgs', 'Souza1Mahmud556', 1, 1, 15, '1230', '01798210399', '01798210399', 'Souza1Mahmud5565155@gm.com', '$2y$10$gO.JJ6yvOiEAwtVBD5vUD.2KQNyPHEKxjZtLBqvBk8C48H0cZoQ..', 'Consumer', 'Active', NULL, NULL),
(17, 'fsgsgs', 'H - 93, Nurul Ahad Masjid Road, Dewanbari, Dakshinkhan, Dhaka-1230', 1, 1, 1, '1230', '01798210399', '01798210399', 'mmashrafe223115@bscse.uiu.ac.bd', '$2y$10$bpLCG9yRTq2PDlwZBOzcU.mrpYWSArbXpOd75HNTmnpuWFQCmJ.NO', 'Consumer', 'Active', NULL, NULL),
(18, 'fsgsgs', 'Souza1Mahmud556', 1, 1, 11, '1230', '01798210399', '01798210399', 'mmashrafe22314415@bscse.uiu.ac.bd', '$2y$10$TorwtorEgXFovy9K90DMyOhLOUoIM/Z.4ryQNxtYvwBSx/8T/QUye', 'Consumer', 'Active', NULL, NULL),
(19, 'Customer', 'customercustomer', 1, 1, 1, '1212', '01798210399', '01798210399', 'customer@gmail.com', '$2y$10$i/rv0TVnFMeMjwW.BBaWregL4fgQyi4UOWLukUTE8ZDsq5kCUi.gm', 'Consumer', 'Active', NULL, NULL),
(20, 'Customer', 'customercustomer', 1, 3, 55, '3550', '01798210399', '01798210399', 'customer1@gmail.com', '$2y$10$nrhcB4bsa4oqZLgHaTvwCuVZMhh/ZHE9CPNM/hba/HAfN/ZGHcAG2', 'Consumer', 'Active', NULL, NULL),
(21, 'Customer', 'customer1AA#', 1, 3, 62, '3550', '01798210399', '01798210399', 'customer12@gmail.com', '$2y$10$nyh3btYQFVAWOO5d/1IiDOgFdairVzABFCEu0XFU7tYVbsi2EXmLa', 'Consumer', 'Active', NULL, NULL);
...
INSERT INTO `messages` (`message_id`, `sender_type`, `sender_id`, `receiver_type`, `receiver_id`, `message_text`, `timestamp`, `is_read`) VALUES
(12, 'customer', 18, 'seller', 6, 'hello', '2025-01-25 19:22:07', 1),
(13, 'customer', 18, 'seller', 6, 'hi', '2025-01-25 19:22:26', 1),
(14, 'seller', 6, 'customer', 18, 'hi', '2025-01-25 19:22:33', 1),
(15, 'customer', 18, 'seller', 7, 'hi', '2025-01-25 19:22:40', 0),
(16, 'seller', 6, 'customer', 18, 'hello', '2025-01-25 19:22:45', 1),
(17, 'customer', 19, 'seller', 8, 'Hello', '2025-01-26 10:16:30', 1),
(18, 'seller', 8, 'customer', 19, 'Hi', '2025-01-26 10:16:43', 1),
(19, 'customer', 19, 'seller', 8, 'I want apple', '2025-01-26 10:17:00', 1),
(20, 'customer', 21, 'seller', 8, 'Do you have apple?', '2025-01-26 19:32:19', 0),
(21, 'customer', 21, 'seller', 9, 'Do you have apple?', '2025-01-26 19:32:28', 1);
...
(12, 5, 1, 177, 156, 'Good Quality Cherry', '187813314images.jpeg', '1298027616images.jpeg', '349178126images.jpeg', '1181912771images.jpeg', '1491872389images.jpeg', 90.00, 'Kilogram', 'Cherry', '2025-01-16', 'Active'),
(13, 6, 1, 1, 1, 'Fresh Banana', '88585044619317banana.jpg', '26267445519317banana.jpg', '82999144619317banana.jpg', '146650471019317banana.jpg', '140257071319317banana.jpg', 0.00, 'PCS', 'Price Range: Per PCs 10TK', '2025-01-21', 'Inactive'),
(14, 8, 2, 20, 478, 'Fresh & High Quality Barley', '15302796003876barley.jpg', '69484587814423barley.jpg', '1021480148341barley.jpg', '62145483722363barley.jpg', '3116336903876barley.jpg', 100.00, 'Kilogram', 'Price: 200 - 250 per Kg', '2025-01-26', 'Active'),
(15, 8, 4, 58, 240, 'Fresh Black Pepper', '27545619210498black pepper.jpg', '206409715010498black pepper.jpg', '100432728210498black pepper.jpg', '17640678110498black pepper.jpg', '82043914110498black pepper.jpg', 200.00, 'Kilogram', 'Price: 500 - 520 per Kg', '2025-01-26', 'Active'),
(16, 8, 7, 91, 594, 'Good Quality Hazelnut Oil    Good for your Health', '13733516429847hazelnut oil.jpg', '183079569129847hazelnut oil.jpg', '182459858429847hazelnut oil.jpg', '188683215529847hazelnut oil.jpg', '31276189929847hazelnut oil.jpg', 200.00, 'Liter', 'Price: 980 - 999 per Liter', '2025-01-26', 'Active'),
(17, 8, 1, 2, 15, 'Imported Red Apple', '20521519830474apple.jpg', '62226321230474apple.jpg', '33254597230474apple.jpg', '186848725830474apple.jpg', '81023405130474apple.jpg', 30.00, 'Kilogram', 'Price: 400 440 per Kg', '2025-01-26', 'Active'),
(18, 8, 6, 75, 585, 'Fresh Apricot', '4011064063270apricot.jpg', '9407335463270apricot.jpg', '21192978993270apricot.jpg', '17919727413270apricot.jpg', '2881762343270apricot.jpg', 112.00, 'Kilogram', 'Price: 750 - 770 per Kg', '2025-01-26', 'Active'),
(19, 8, 1, 174, 127, 'Mango', '16141607532931mango.jpg', '10252047422931mango.jpg', '772789702931mango.jpg', '11347136302931mango.jpg', '451529942931mango.jpg', 500.00, 'Kilogram', 'Price: 550 - 575 per Kg', '2025-01-26', 'Inactive'),
(20, 8, 5, 152, 398, 'Cauliflower', '12897765922102cauliflower.jpg', '16988605302102cauliflower.jpg', '4675666392102cauliflower.jpg', '16429212932102cauliflower.jpg', '6225331632102cauliflower.jpg', 300.00, 'PCS', 'Price: 30 - 35 per PCS', '2025-01-26', 'Active'),
(21, 8, 1, 1, 452, 'Fresh Quality Fruit', '109774247919317banana.jpg', '200384325119317banana.jpg', '35822682119317banana.jpg', '21391152219317banana.jpg', '183589084919317banana.jpg', 300.00, 'PCS', 'Price: 10 - 12 per PCS', '2025-01-26', 'Active'),
(22, 8, 3, 43, 499, 'Basil Seeds', '160408219924981basil seeds.jpg', '20700397924981basil seeds.jpg', '36972954624981basil seeds.jpg', '87216927224981basil seeds.jpg', '43969052524981basil seeds.jpg', 200.00, 'Gram', 'Price: 200 - 210 per Gram', '2025-01-26', 'Active'),
(23, 9, 1, 15, 109, 'Brandywine Raspberries', '12849421871239Brandywine Raspberries.jpg', '21043612181239Brandywine Raspberries.jpg', '3575440351239Brandywine Raspberries.jpg', '7901432591239Brandywine Raspberries.jpg', '7532517041239Brandywine Raspberries.jpg', 100.00, 'Kilogram', 'Price: 1010 - 1090 per Kg', '2025-01-26', 'Active');
...
(57, 19, 1, 1, 1, 'Customer', 'customercustomer', 'Customer', '01798210399', '2025-01-26', 'Active', 'Cash on delivery', 'Card type -  , Card number -  ,  CVV number - ', 0);
...
(20, 13, 33, 9, 6, '2025-01-21', '04:21:12', 100.00, 10.00, 'Paid'),
(21, 13, 34, 9, 6, '2025-01-22', '06:21:51', 200.00, 20.00, 'Pending'),
(22, 13, 35, 9, 6, '2025-01-22', '06:48:20', 300.00, 30.00, 'Pending'),
(23, 13, 37, 9, 6, '2025-01-22', '07:11:36', 900.00, 90.00, 'Paid'),
(24, 17, 40, 19, 8, '2025-01-26', '12:27:26', 4000.00, 20.00, 'Paid');
...
(16, 20, 'Visa', 'Card Holder name: akjsdghjksagh Card Number: 4111111111111111 Expiry date: 2025-02 CVV No.443', '2025-01-21', 100.00, 'Active'),
(17, 23, 'Visa', 'Card Holder name: aadds Card Number: 4111111111111111 Expiry date: 2025-02 CVV No.123', '2025-01-22', 900.00, 'Active'),
(18, 24, 'Visa', 'Card Holder name: aadds Card Number: 4777122289882323 Expiry date: 2025-03 CVV No.232', '2025-01-26', 4000.00, 'Active');
...
(33, 9, 13, 0, 10.00, '2025-01-21', '2025-01-28', '', 'Active'),
(34, 9, 13, 0, 20.00, '2025-01-22', '2025-01-29', '', 'Active'),
(35, 9, 13, 0, 30.00, '2025-01-22', '2025-01-29', '', 'Active'),
(36, 9, 13, 0, 30.00, '2025-01-22', '2025-01-29', '', 'Pending'),
(37, 9, 13, 0, 90.00, '2025-01-22', '2025-01-29', '', 'Active'),
(40, 19, 17, 0, 20.00, '2025-01-26', '2025-02-02', '', 'Active');
...
(6, 'KBS', 'H - 93, Nurul Ahad Masjid Road, Dewanbari, Dakshinkhan, Dhaka-1230', 2, 1, 40, '2313', '8600611198', '01512687144', 'mmashrafe22313152@bscse.uiu.ac.bd', 'mmashrafe22', 'DBBL', 'Chittagong', 'DBBLBDDH', '2342432432544253535', 'Active'),
(7, 'sfkjhskdh', 'dsdfsf', 1, 1, 1, '4353', '01812172975', '01812172975', 'uyesgfyuydg@bscse.uiu.ac.bd', 'uyesgfyuydg', 'EBBL', 'Uttara', 'Asadssas', '2342432324325325', 'Active'),
(8, 'Farmer', 'farmerfarmer', 1, 1, 1, '1212', '01912687155', '01912687155', 'farmer@gmail.com', 'farmerfarmer', 'IFIC', 'Badda', 'IFIKBDDH', '55345345435', 'Active'),
(9, 'Farmer', 'farmerfarmer', 3, 1, 55, '4343', '01912689244', '01912689244', 'farmer1@gmail.com', 'farmerfarmer', 'DBBL', 'Khulna', 'DBBLBDKH', '2342432432544253535', 'Active');
...
(1, 1, 'Dhaka', 'Capital division of Bangladesh', 'active'),
(2, 1, 'Chattogram', 'Coastal division and business hub', 'active'),
(3, 1, 'Khulna', 'Industrial and port city', 'active'),
(4, 1, 'Rajshahi', 'Cultural and historical hub', 'active'),
(5, 1, 'Sylhet', 'Tea gardens and hill tracts', 'active'),
(6, 1, 'Barishal', 'Riverine division', 'active'),
(7, 1, 'Rangpur', 'Agricultural powerhouse', 'active'),
(8, 1, 'Mymensingh', 'Emerging industrial area', 'active');
...
(5, 'Kabir Hossain', 'H - 93, Nurul Ahad Masjid Road, Dewanbari, Dakshinkhan, Dhaka-1230', 1, 1, 1, '1230', 'Experienced', '871707619IEEEXplore_Global_All-Courses.pdf', '01798210399', '1988-02-02', 'mmashrafe223115@bscse.uiu.ac.bd', 'mmashrafe223115', 20000.00, 'Active'),
(6, 'Worker', 'workerworker', 1, 1, 1, '1230', 'Well Experienced', '235974112IEEEXplore_Global_All-Courses.pdf', '01923457612', '1996-02-22', 'worker@gmail.com', 'workerworker', 100000.00, 'Active');
...
(16, 5, 5, '2025-01-23', '2025-01-31', 'Fertilize', 1, 7, 27, 20000.00, 'Wage', 'Approved', '', 'No', ''),
(17, 6, 8, '2025-01-29', '2025-01-31', 'Farming', 1, 1, 1, 9090.00, 'Wage', 'Approved', 'Approved', 'I want full focused', '');
...
--
ALTER TABLE `article`
  MODIFY `article_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `product_purchase_record`
  MODIFY `purchase_record_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;
...
--
ALTER TABLE `purchase_order_bill`
  MODIFY `purchase_order_bill_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `purchase_request`
--
ALTER TABLE `purchase_request`
  MODIFY `purchase_request_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
