...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/img/Shombhar_favicon.png" rel="icon">
  <link href="assets/img/Shombhar_favicon.png" rel="apple-touch-icon">
...
<li class="drop-down <?php
  ...
  <li><a href="messages.php">Chat</a></li>
	...
	<li class="drop-down"><a href="#">Hire details</a>
	  <ul>
			<li><a href="viewworkerrequest.php">View Hired Worker (Agriculture officer) </a></li>
	  </ul>
	</li>
